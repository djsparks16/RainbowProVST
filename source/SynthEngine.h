...
public:
    ...
    void reset()
    {
        ...
        age = 0; basePan = 0.5f; releaseSamples = 0; postToneL = postToneR = 0.0f; warmToneL = warmToneR = 0.0f;
    }
    ...
    {
        active = true; held = true; midiNote = note; velocity = vel; age = newAge; releaseSamples = 0; postToneL = postToneR = 0.0f; warmToneL = warmToneR = 0.0f;
